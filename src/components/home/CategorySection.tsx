  ...
  <section className="py-20">
    <div className="container mx-auto px-4">
      <FadeUp className="text-center mb-12">
        ...
        <p className="text-muted-foreground max-w-xl mx-auto">Explore our complete range of solar and electrical products</p>
      </FadeUp>
          ...
          <StaggerItem key={cat.id}>
            <Link to={`/products?category=${cat.slug}`}>
              <motion.div
                ...
                className="group relative rounded-2xl overflow-hidden bg-card border border-border aspect-[4/3] flex flex-col items-center justify-end p-6 transition-shadow hover:shadow-[var(--shadow-hover)]"
              >
                <img
                  src={cat.image}
                  alt={cat.name}
                  ...
                  loading="lazy"
                />
                <div className="relative z-10 text-center bg-card/90 backdrop-blur-sm rounded-xl px-4 py-3 w-full">
